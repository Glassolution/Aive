  ...
  head: () => ({
    meta: [
      { title: "Bem-vindo à Aive" },
      {
        name: "description",
        content:
          "Pagamento confirmado. Preencha o formulário de onboarding para iniciarmos sua campanha.",
      },
    ],
  }),
});
        ...
        <section className="mx-auto mt-10 max-w-3xl overflow-hidden rounded-2xl border border-border bg-card shadow-sm shadow-black/[0.04]">
          <div className="border-b border-border px-5 py-5 sm:px-7">
            <p className="text-xs font-semibold uppercase tracking-[0.16em] text-muted-foreground">
              ETAPA 1 DE 1 · FORMULÁRIO DE ONBOARDING
            </p>
          ...
          <form className="space-y-5 p-5 sm:p-7" onSubmit={(event) => event.preventDefault()}>
            ...
            <label className="block">
              <span className="text-sm font-medium text-foreground">
                Qual serviço de roofing você oferece? *
              </span>
              <select
            ...
            />
            <FormField
              label="Qual seu ticket médio por job? *"
              name="average-ticket"
